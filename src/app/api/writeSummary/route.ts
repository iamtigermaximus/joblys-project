...
//   resumeData = structuredCV.content as any; // Assuming structuredCV.content is of type Resume

//   let responsibilities = resumeData.professional.work.map(
//     job => `${job.jobTitle}: ${job.jobDetails}`,
//   );
...
//       {
//         body: {
//           message: 'There are no job details to write a summary',
//         },
//       },
//       { status: 500 },
//     );
